...
// // --- DATA: THE STORY CHAPTERS (UPDATED WITH IMAGES) ---
// const STORY_CHAPTERS = [
//   {
//     title: "The New Girl",
//     img: "/first_meet.png", // Make sure this file exists in public/
...
// --- DATA: BLUSH MESSAGES (NEW EVERY VISIT) ---
...
const STORY_CHAPTERS = [
  ...
  },
  {
    title: "The Front Bench War",
    img: "/memory-5.jpg",
    text: "In Class 7, you sat right in front of me. We were friends, but you had a crush on someone else. It made me so jealous! I used to steal your copies & files just to hold something of yours. And remember that guy who shoulder-rubbed you? I fought him. Because even if you liked someone else, I was the one protecting you."
  },
  {
    title: "The Kabaddi Miracle",
    img: "/memory-6.jpg",
    text: "My heart remembers this clearly. Sunny afternoon, end of corridor. You were playing Kabaddi and ran into me. For a moment, everything stopped. I held you. My only hug. I dream of that. I want you to run to me again, and this time, I will catch you and never let you go."
  }
];
...
const MESSAGES = [
  ...
  {
    id: "ghibli_pic",
    date: "Us in Another Universe",
    title: "A Glimpse of Forever",
...
export default function UltimateApology() {
  ...
  // --- LOGIC: ROTATE MESSAGES ON VISIT ---
  useEffect(() => {
    // 1. Get visit count from local storage (or 0 if new)
    ...
    // 2. Select message based on count (Loop back if we run out)
    const msgIndex = count % BLUSH_MESSAGES.length;
    setTodaysBlushMsg(BLUSH_MESSAGES[msgIndex]);

    // 3. Increment count for NEXT time (only if we haven't already this session)
    // We use sessionStorage to ensure we don't increment if she just refreshes
        ...
        {showBlushWelcome && (
          ...
          >
             ...
             >
                ...
                <p className="text-xl text-white/90 leading-relaxed font-light italic mb-8">
                  "{todaysBlushMsg}"
                </p>

                <button 
                  onClick={() => setShowBlushWelcome(false)}
                  className="px-8 py-3 bg-white text-teal-900 font-bold rounded-full hover:scale-105 active:scale-95 transition-transform"
                >
            ...
            >
              ...
              <div className="bg-white/70 backdrop-blur-xl p-8 md:p-14 rounded-[2rem] shadow-[0_10px_40px_-10px_rgba(13,148,136,0.2)] border border-white relative overflow-hidden min-h-[500px] flex flex-col justify-center">
                ...
                {activeMessage.isStory ? (
                  ...
                  // === IMAGE MODE (GHIBLI STYLE) ===
                  <div className="flex flex-col items-center justify-center">
                    <motion.div 
                      initial={{ scale: 0.8, rotate: -5, opacity: 0 }}
                      animate={{ scale: 1, rotate: 0, opacity: 1 }}
                      transition={{ type: "spring", duration: 1.5 }}
                      className="bg-white p-4 pb-12 shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500 max-w-sm"
                    >
                      <div className="aspect-square w-full bg-teal-100 relative overflow-hidden mb-2">
                        <Image 
                          src="/ghibli-us.png" 
                          alt="Us in Ghibli Style" 
                          width={400} 
                          height={400}
                          className="object-cover w-full h-full"
                        />
                      </div>
                      <div className="text-center font-handwriting text-slate-600 font-bold text-xl mt-4" style={{ fontFamily: 'cursive' }}>
                        Me & You (In my dreams) ❤️
                      </div>
                    </motion.div>
                    <p className="mt-8 text-center text-teal-800/60 text-sm italic">
                      "Remember when you hopped on my bus just to see my village? <br/> That was the moment I knew."
                    </p>
                  </div>
                ) : activeMessage.isInteractive ? (
                  // === SLAP MODE ===
